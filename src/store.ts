        ...
        builder
            ...
            .addCase(starEnterAction, (state, action) => {
                ...
                if (state.sky.focusedStarId) {
                    ...
                    const constellation = state.sky.constellations.find(
                        constellation =>
                            constellation.constellation.stars.some(star => star.id === action.payload)
                    )
                    if (constellation && constellationIsComplete(constellation.constellation, state.sky.edges)) {
